		...
		"outputs": [
			{
				"components": [
					...
					},
					{
						...
						"internalType": "struct MyToken.DeploymentConfig",
						"name": "deploymentConfig",
						"type": "tuple"
					},
					{
						...
						"internalType": "struct MyToken.RuntimeConfig",
						"name": "runtimeConfig",
						"type": "tuple"
					}
				],
				"internalType": "struct MyToken.ContractInfo",
				"name": "info",
				"type": "tuple"
			}
		],
...
export const rpcURL:any = async(curr:any) =>{
  if(curr === 'bsc'){
...
export const blockExplorer = async (curr:any) =>{
  if(curr === 'bsc'){
